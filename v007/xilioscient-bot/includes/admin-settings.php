...
class XSBOT_Admin_Settings {
    ...
    private static function handle_image_upload($field_name) {
        ...
        if ($movefile && !isset($movefile['error'])) {
            update_option($field_name, $movefile['url']);
            add_settings_error('xsbot_messages', 'xsbot_message', __('Immagine caricata', 'xilioscient-bot'), 'success');
        }
    }
    ...
    public static function render_settings_page() {
        ...
        if (isset($_FILES['xsbot_profile_image']) && !empty($_FILES['xsbot_profile_image']['name'])) {
            self::handle_image_upload('xsbot_profile_image');
        }

        if (isset($_FILES['xsbot_banner_image']) && !empty($_FILES['xsbot_banner_image']['name'])) {
            self::handle_image_upload('xsbot_banner_image');
        }
