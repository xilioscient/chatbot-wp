 ...
 * Plugin URI: https://github.com/yourorg/xilioscient-bot
...
class XilioScient_Bot {
    ...
    public function enqueue_admin_assets($hook) {
        // Solo sulla pagina delle impostazioni del plugin
        if ('toplevel_page_xsbot-settings' !== $hook) {
            return;
        }
        ...
        wp_localize_script('xsbot-admin', 'xsbotAdmin', array(
            'ajaxUrl' => admin_url('admin-ajax.php'),
            'restUrl' => rest_url('mlc/v1/'),
            'nonce' => wp_create_nonce('xsbot_admin_nonce'),
            'strings' => array(
